...
HD_PWD='C:/Users/clayton/src/551-lab2/551-lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log square_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source square_top.tcl -notrace
