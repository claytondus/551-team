...
HD_PWD='C:/Users/clayton/src/551-lab2/551-lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log square_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source square_top.tcl
