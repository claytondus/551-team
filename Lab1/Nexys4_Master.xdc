...
set_property PACKAGE_PIN T3 [get_ports {OpCode[0]}]					
...
set_property PACKAGE_PIN R3 [get_ports {OpCode[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OpCode[2]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {OpCode[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {OpCode[3]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {OpCode[4]}]					
...
set_property PACKAGE_PIN P2 [get_ports {neg}]					
...
set_property PACKAGE_PIN N6 [get_ports {s3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {s3}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {s2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {s2}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {s1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {s1}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {s0}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {s0}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {one}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {one}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {one2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {one2}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {one3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {one3}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {one4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {one4}]
...
set_property PACKAGE_PIN E16 [get_ports button]						
